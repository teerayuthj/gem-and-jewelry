...
<footer id="footer" class="gold ">
		...
		<div class="footer-sub">
			<div class="footer-detail">
				...
				<ul class="social-list">
                    <li><p><a class="text-reset list-foo" href="https://www.facebook.com/ausirisgoldofficial/" target="_blank"><img src="/etc/designs/ausiris-gold/img/icon-1.svg" alt=""></a></p></li>
                    <li><p><a class="text-reset list-foo" href="https://twitter.com/ausirisgold" target="_blank"><img src="/etc/designs/ausiris-gold/img/icon-2.svg" alt=""></a></p></li>
                    <li><p><a class="text-reset list-foo" href="https://www.youtube.com/user/ausirisgroup" target="_blank"><img src="/etc/designs/ausiris-gold/img/icon-3.svg" alt=""></a></p></li>
                    <li><p><a class="text-reset list-foo" href="https://www.instagram.com/ausirisgold/" target="_blank"><img src="/etc/designs/ausiris-gold/img/icon-5.svg" alt=""></a></p></li>
				</ul> -->
    ...
    <a style="margin: 0 15px 0 0;" href="https://web.facebook.com/ausirisnextgoldinvestment" class="social-i" data-is-external="false" data-has-more="false" data-has-children="true" title="Facebook" data-track="click" data-type="social" data-id="ausiris:footer:social" rel="noopener noreferrer nofollow" target="_blank">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" class="" aria-label="Facebook Icon Button"><path fill="white" fill-rule="evenodd" d="M22.1 11.0C22.1 4.9 17.1 0 11.0 0S0 4.9 0 11.0C0 16.5 4.0 21.1 9.3 22v-7.7h-2.8v-3.1h2.8V8.6c0-2.7 1.6-4.3 4.1-4.3 1.2 0 2.4.216 2.4.216v2.7H14.6c-1.3 0-1.8.853-1.8 1.7v2.0h3.0l-.49 3.2h-2.5V22c5.2-.83 9.3-5.4 9.3-10.9"></path></svg></a>
    <a style="margin: 0 15px 0 0;" href="https://www.instagram.com/ausirisgold/" class="social-i" data-is-external="false" data-has-more="false" data-has-children="true" title="Instagram" data-track="click" data-type="social" data-id="ausiris:footer:social" rel="noopener noreferrer nofollow" target="_blank">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" class="" aria-label="Instagram Icon Button"><g fill="white"><path d="M11 0 6.5.1c-1.2.1-2 .2-2.7.5-.7.3-1.4.7-2 1.2A5 5 0 0 0 .5 3.7C.3 4.5.1 5.3.1 6.5L0 11a42.8 42.8 0 0 0 .6 7.2 5 5 0 0 0 1.3 1.9 5 5 0 0 0 1.9 1.3c.7.3 1.5.5 2.7.5l4.5.1 4.5-.1c1.2-.1 2-.2 2.7-.5a5 5 0 0 0 1.9-1.3 5 5 0 0 0 1.3-1.9c.3-.7.5-1.5.5-2.7L22 11l-.1-4.5c-.1-1.2-.2-2-.5-2.7a5 5 0 0 0-1.3-1.9A5 5 0 0 0 18.2.6c-.7-.3-1.5-.5-2.7-.5L11 0zm0 2 4.4.1c1.1 0 1.7.2 2 .4.5.2.9.4 1.3.8s.6.8.8 1.3l.4 2L20 11l-.1 4.4c0 1.1-.2 1.7-.4 2-.2.5-.4.9-.8 1.3s-.8.6-1.3.8l-2 .4-4.4.1H6.6c-1.1 0-1.7-.2-2-.4-.5-.2-.9-.4-1.3-.8s-.6-.8-.8-1.3c-.2-.4-.3-1-.4-2L2 11V6.6c0-1.1.2-1.7.4-2 .2-.6.5-1 .8-1.4l1.3-.8c.4-.2 1-.3 2-.4H11z"></path><path d="M11 14.5c-2 0-3.6-1.6-3.6-3.6C7.4 9 9 7.4 11 7.4S14.6 9 14.6 11a3.7 3.7 0 0 1-3.6 3.5zm0-9C8 5.5 5.5 8 5.5 11S8 16.5 11 16.5s5.5-2.5 5.5-5.5S14 5.5 11 5.5zm6.9-.4c0 .7-.6 1.3-1.3 1.3s-1.3-.6-1.3-1.3c0-.7.6-1.3 1.3-1.3s1.3.6 1.3 1.3"></path></g></svg></a>
    ...
    <a style="margin: 0 15px 0 0;" href="https://www.youtube.com/ausirisgroup" class="social-i" data-is-external="false" data-has-more="false" data-has-children="true" title="Youtube" data-track="click" data-type="social" data-id="ausiris:footer:social" rel="noopener noreferrer nofollow" target="_blank">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="22" viewBox="0 0 32 22" class="" aria-label="YouTube Icon Button"><path fill="white" fill-rule="evenodd" d="M15.6.246c1.2.003 9.7.047 11.9.65a3.8 3.8 0 0 1 2.7 2.7c.602 2.2.646 6.7.65 7.4v.156c-.004.6-.048 5.1-.65 7.4a3.8 3.8 0 0 1-2.7 2.7c-2.2.59-10.4.644-11.9.649h-.457c-1.4-.005-9.7-.059-11.9-.65A3.8 3.8 0 0 1 .65 18.6C.032 16.2.002 11.6 0 11.1v-.07c.002-.452.0-5.1.65-7.4A3.8 3.8 0 0 1 3.3.895C5.6.293 14.1.25 15.3.246zm-3.2 6.2v9.3l8.0-4.6-8.0-4.6z"></path></svg></a>
    <a style="margin: 0 15px 0 0;" href="https://www.tiktok.com/@ausirisgold" class="social-i" data-is-external="false" data-has-more="false" data-has-children="true" title="TikTok" data-track="click" data-type="social" data-id="ausiris:footer:social" rel="noopener noreferrer nofollow" target="_blank">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" class="" aria-label="TikTok Icon Button"><path fill="white" fill-rule="nonzero" d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.15 2.7 1.68 4.24 1.85v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.93 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"></path></svg></a>
  </section>
			</div>
		  <!--	<ul class="menu-list">
                  <%
        if (navRootPage != null) { 
            ...
            %><li><a href="<%= child.getPath() %>.html" class="txt_color3"><%=child.getTitle() %></a></li>

                <%
        	} 
    	} 
                  %>
                <li><a target="_blank" href="https://blog.ausiris.co.th/" class="txt_color3">บทความ</a></li> 
    ...
    <!-- Section: Links  -->
		...
		<div class="footer-undersub">
			<h6 class="footer-copyright txt_color3">
				© <%= java.util.Calendar.getInstance().get(java.util.Calendar.YEAR) %> Ausiris, All Rights Reserved
			</h6>
			<div class="footer-store-list">
                <li style="margin-right: 3px;"><a href="http://www.ausirisgroup.com/aspen/" target="_blank"><img class="img-responsive" target="_blank" src="http://www.ausiris.co.th/content/dam/ausirisgold/logo/aspen.png"  width="91px" style="border-radius: 5px;" alt=""></a></li>
				<li><a href="https://play.google.com/store/apps/details?id=com.fg.mdp.psi.ausiris&hl=en" target="_blank"><img class="img-responsive" target="_blank" src="/etc/designs/ausiris-gold/img/googleplay.png" width="93px" alt=""></a></li>
				<li><a href="https://itunes.apple.com/th/app/ausiris-gold-investment-trade/id986699897?mt=8" target="_blank"><img class="img-responsive" target="_blank" src="/etc/designs/ausiris-gold/img/appstore.png" width="101px" alt=""></a></li>
			</div>
		</div>
	</div>
</footer>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" />
 ...
 #footer { contain: layout; }
    ...
    #footer .privacy-mt { padding-left: 12px !important; padding-right: 12px !important; margin-bottom: 12px !important; }
