...
(function () {
    ...
    function menu() { return document.getElementById('agsTradeDropdown'); }
    ...
    function isTrigger(el) {
        ...
        var h = el.getAttribute ? el.getAttribute('href') : null;
    ...
    function openUnder(btn) {
        ...
        if (!m) { return false; }
        cancelClose();
        m.className = 'ags-dd is-open';

        var r = btn.getBoundingClientRect();
        var left = r.right - m.offsetWidth;      // ชิดขอบขวาของปุ่ม
        ...
        if (top + h > window.innerHeight - 8 && r.top - 10 - h > 8) {
            ...
            m.className = 'ags-dd is-open is-up';
        }
        m.style.top = top + 'px';
