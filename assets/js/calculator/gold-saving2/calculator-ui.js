...
window.ProductRenderer = {
    ...
    openVariantModal(weightLabel, options = {}, t, loadLazyImageCallback, openImageLightboxCallback) {
        ...
        // Setup variant modal effects after animation starts
        setTimeout(() => {
            if (window.modernLuxuryEffects && typeof window.modernLuxuryEffects.setupVariantModalEffects === 'function') {
                window.modernLuxuryEffects.setupVariantModalEffects();
            }
        }, 100);
